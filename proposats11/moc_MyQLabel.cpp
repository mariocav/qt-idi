...
static const char qt_meta_stringdata_MyQLabel[] = {
    "MyQLabel\0\0cotxe()\0camio()\0moto()\0"
    "obert()\0tancat()\0unEuro()\0quatreEuro()\0"
};
...
void MyQLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cotxe(); break;
        case 1: _t->camio(); break;
        case 2: _t->moto(); break;
        case 3: _t->obert(); break;
        case 4: _t->tancat(); break;
        case 5: _t->unEuro(); break;
        case 6: _t->quatreEuro(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
